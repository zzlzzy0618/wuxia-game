...
const BOSSES = {
  ...
  duanyanping: boss('大理逆徒 · 段延平', 35, { hpMul: 9.2, atkMul: 2.02, flavor: '"段氏的江山，本来就该是我的！"', skills: [{ name: '一阳指 · 邪焰', mult: 2.6, chance: .45 }, { name: '段家剑 · 血影', mult: 2.0, chance: .32 }], reward: { silver: 6500, potions: { xuelian: 2 }, sp: 'daliYudai' } }),
  chenguiseng: boss('恶僧 · 成鬼僧', 39, { hpMul: 9.7, atkMul: 2.0, flavor: '"混元霹雳功成之日，便是尔等授首之时！"', skills: [{ name: '幻阴指', mult: 2.75, chance: .42 }], reward: { silver: 9000, skill: 'qiankun', sp: 'shenghuo' } }),
